...
import customer_info.Address;
import customer_info.Customer;
import manage.InternetOrdersManager;
import manage.NoFreeTableException;
import manage.NoSuchOrderException;
import manage.TableOrdersManager;
import menu.*;
import order.InternetOrder;
import order.Order;
import order.TableOrder;
...
public class Interface {
    ...
    public void sI1(Scanner sc) throws WrongNumberException {
        ...
        System.out.println("(1) Create new order / (2) Get cost summary / (3) Remove head order / (4) Item's quantity" +
    ...
    public void sT1(Scanner sc) throws WrongNumberException, NoFreeTableException {
        ...
        switch (section){
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println("Select the table whose order to delete: ");
